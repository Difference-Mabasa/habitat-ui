    ...
    body: (
      <>
        ...
        <p style={{ margin: "0 0 16px", color: "var(--slate)" }}>
          ...
          <span style={{ color: "var(--ink)", fontWeight: 600 }}>R 0.00</span> on or before the 1st of
        ...
        <p style={{ margin: "0 0 16px", color: "var(--slate)" }}>
          The deposit, equal to one (1) month's rent, is held in an interest-bearing trust account in the
          Tenant's name as required by section 5(3)(b) of the Rental Housing Act.
        </p>
        <h3 style={{ fontSize: 14, fontWeight: 600, marginTop: 24, marginBottom: 12 }}>5. Term</h3>
        <p style={{ margin: "0 0 16px", color: "var(--slate)" }}>
          This lease commences on the agreed start date and continues for a fixed term of twelve (12)
          months. Either party may terminate on twenty (20) business days' written notice without penalty,
        ...
        <div style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) 380px", gap: 32 }}>
          ...
          {stage === "template" ? (
            ...
            <Card padding={32}>
              <Alert tone="danger" title="You declined this lease">
                ...
                next applicant in the queue. You can browse similar spots, or message the landlord if this
                was a mistake.
              </Alert>
              ...
              <div style={{ marginTop: 20, display: "flex", gap: 8, justifyContent: "flex-end" }}>
                <Link to="/inbox" style={{ textDecoration: "none" }}>
                  <Button variant="ghost" leftIcon="chat">Message landlord</Button>
                </Link>
          ...
          <aside style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <Card padding={20}>
              ...
              <KeyValueRow label="Property" value="—" size="sm" />
              <KeyValueRow label="Landlord" value="—" size="sm" />
              <KeyValueRow label="Term" value="—" size="sm" />
              <KeyValueRow label="Start" value="—" size="sm" />
              <KeyValueRow label="Rent" value="R 0 / mo" size="sm" />
              <KeyValueRow label="Deposit" value="R 0" size="sm" />
              <KeyValueRow
                label="Template"
                value={
                  <span className="mono">
            ...
            <Card padding={20}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 0" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div>
                    <div style={{ fontSize: 13 }}>Landlord</div>
